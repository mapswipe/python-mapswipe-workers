...
class TestCreateTutorialBuildArea(unittest.TestCase):
    def setUp(self) -> None:
        ...
        tutorial_file = os.path.join(data_dir, "tutorials", "build_area_tutorial.json")
    ...
    def test_create_tutorial(self):
        ...
        project_file = os.path.join(
            data_dir, "projects", "build_area_tutorial_project.pickle"
        )
    ...
    def test_create_tutorial_groups(self):
        ...
        groups_file = os.path.join(
            data_dir, "groups", "build_area_tutorial_groups.pickle"
        )
    ...
    def test_create_tutorial_tasks(self):
        ...
        test_dir = os.path.dirname(__file__)
        data_dir = os.path.join(test_dir, "fixtures", "tile_map_service_grid")
        tasks_file = os.path.join(data_dir, "tasks", "build_area_tutorial_tasks.pickle")
