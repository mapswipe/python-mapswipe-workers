...
from mapswipe_workers.project_types import ChangeDetectionProject
from tests import fixtures


class TestChangeDetectionProject(unittest.TestCase):
    def setUp(self):
        ...
        self.project = ChangeDetectionProject(project_draft)
