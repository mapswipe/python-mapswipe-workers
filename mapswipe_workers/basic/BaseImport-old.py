...
class BaseImport(object):
    ...
    def create_project(self, firebase, postgres):
        ...
        try:
            ...
            # TODO: self.execute_import_queries(postgres, project_id, project_dict, groups_dict)
    ...
    def execute_import_queries(self, postgres, project_id project_dict, groups_dict):
        ...
        # get groups and tasks data as text file for faster import into database
        # groups_txt_filenames = []
        # tasks_txt_filenames = []
        ...
        try:
            ...
            # for groups_txt_filename in groups_txt_filenames: 
            #     self._db_cur.execute(query_create_raw_groups, None)
            #     self._db_cur.execute(query_create_raw_groups, None)
