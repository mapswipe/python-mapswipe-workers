...
CREATE INDEX v1_tasks_task_id ON v1_tasks USING btree (task_id);
CREATE INDEX v1_tasks_groupid ON v1_tasks USING btree (group_id);
CREATE INDEX v1_tasks_projectid ON v1_tasks USING btree (project_id);
