...
exports.counter = functions.database.ref('/results/{projectId}/{groupId}/{userId}/').onWrite((snapshot, context) => {
...
exports.projectCounter = functions.database.ref('/groups/{projectId}/{groupId}/requiredCount/').onUpdate((groupRequiredCount, context) => {
...
//
// Gets triggered when group.requiredCount gets changed
exports.calcGroupProgress = functions.database.ref('/groups/{projectId}/{groupId}/requiredCount/').onUpdate((groupRequiredCount, context) => {
...
exports.incProjectProgress = functions.database.ref('/projects/{projectId}/resultCount/').onUpdate((projectResultCount, context) => {
    const projectNumberOfTasksRef = admin.database().ref('/projects/'+context.params.projectId+'/numberOfTasks')
...
exports.decProjectProgress = functions.database.ref('/projects/{projectId}/numberOfTasks/').onUpdate((projectNumberOfTasks, context) => {
